...
class _UserRemoteDataSource implements UserRemoteDataSource {
  _UserRemoteDataSource(
    ...
    baseUrl ??= 'https://node-mongo-pagination.onrender.com/api/v1';
  }
  ...
  Future<PaginatedResponse> getUsers(
    ...
    final _headers = <String, dynamic>{r'Content-Type': optionalHeader};
    ...
    final _result = await _dio
      ...
      headers: _headers,
      extra: _extra,
      contentType: optionalHeader,
    )
            .compose(
              _dio.options,
              '/users/getUsers?limit=${limit}&page=${page}',
    ...
    final _value = PaginatedResponse.fromJson(_result.data!);
    return _value;
  }
